        ...
        <div className="landing">
            <Stack direction="row">
                ...
                <Tabs value={value} onChange={handleChange} style={{marginTop: 15, marginLeft: 30}}>
                    ...
                    <Tab label="Profile" href="/student-profile" to={handleProfileClick} icon={<PersonIcon style={{fontSize: 28}}/>} iconPosition="start" style={{fontSize: 30, fontWeight: "bold", color: "black", marginRight: 30}}/>
                </Tabs>
