    ...
    <div>
      <div className="jonas-angelo-clamor-view-collection-of-assessments-assess-jonas-angelo-clamor-view-collection-of-assessments-assess">
        ...
        <span className="jonas-angelo-clamor-view-collection-of-assessments-assess-text13">
          <span>
            <span>
              Planning, analysis, and design must come before implementation
              when creating medium- and large-scale
              <span
            ...
            <br></br>
            <span>
              software systems. This course introduces students to the
              fundamentals of software design, with an emp-
            </span>
            <br></br>
            <span>
              hasis on the Planning, Analysis, Design, and Implementation phases
              of creating software application sys-
            </span>
            <br></br>
            <span>
              ems. Additionally, this course introduces the usage of
            ...
            <br></br>
            <span>
              such as online project management applications and software code
              repositories.
            </span>
          </span>
        </span>
